...
\todo[inline]{X skala na grafu naj gre le do 1000. Meritve (modro) naj bodo samo točke. Po potrebi še zoom po Y, da se dobro vidijo točke okoli vrha in parabola.}
...
Korelacije med osnovnimi meritvami \todo{kaj so to osnovne meritve?} in meritvami referen"cnega tipala se gibljejo okoli 0,7. Primer grafa je viden na sliki \ref{comparison}.

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=16cm]{comparison.pdf}
\todo[inline]{Ni jasno, kaj je črna krivulja.}
...
\todo[inline]{Kakšno časovno popvprečenje je bilo tu na RPi?}
		\caption{Primerjava meritev z referen"cnim tipalom po histogramski analizi, ko opazujemo samo pulze ustrenih višin.}
